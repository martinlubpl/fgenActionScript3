...
<tr>
  ...
  <tr>
    <td>Eyes:</td>
    <td>
      <select style="color:#333333" name="eyes">
    ...
    <td>&nbsp;</td>
    <td>Hair:</td>
    <td><select style="color:#333333" name="hair">
      <option style="color:#333333">Choose:</option>
      <option style="color:#333333" value="brown">brown</option>
      <option style="color:#333333" value="lightbrown">lightbrown</option>
      <option style="color:#333333" value="blonde">blonde</option>
      <option style="color:#333333" value="black">black</option>
      <option style="color:#333333" value="red">red</option>
      <option style="color:#333333" value="grey">grey</option>
    </select></td>
  </tr>
  <tr>
    <td>Startpage:</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>Category: *</td>
    <td><select name="category" id="category" style="color:#333333" onchange="disableCat(this)">
      <option style="color:#333333">Choose:</option>
      <option style="color:#333333" value="woman">woman</option>
      <option style="color:#333333" value="man">man</option>
      <option style="color:#333333" value="people">talent</option>
    </select>
    </td>
  </tr>
  <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Subcategory:</td><td>
  <select style="color:#333333" disabled name="subcategory" id="subcategory">
      <option style="color:#333333">Choose:</option>
      <option style="color:#333333" value="fashion">fashion</option>
      <option style="color:#333333" value="business">business</option>
      <option style="color:#333333" value="senior">senior</option>
      <option style="color:#333333" value="exotic">exotic</option>
      <option style="color:#333333" value="specials">specials</option>
      <option style="color:#333333" value="teens">teens</option>
      <option style="color:#333333" value="actors">actors</option>
    </select>
  ...
  <tr>
    <td>Man/Woman:</td>
    <td><select style="color:#333333" name="man_woman" id="man_woman" disabled>
      <option style="color:#333333">Choose:</option>
      <option style="color:#333333" value="woman">woman</option>
      <option style="color:#333333" value="man">man</option>
    </select></td>
    ...
    <td><select style="color:#333333" name="national">
      <option style="color:#333333">Choose:</option>
      <option style="color:#333333" value="national">in town</option>
  ...
  <tr>
    <td colspan="5" align="center"><b>ADD SEDCARD PDF:</b>&nbsp;&nbsp;&nbsp;&nbsp;<br>
      <input type="hidden" name="MAX_FILE_SIZE" value="3000000" />
      <input name="pdf_file" type="file" style="color:#333333; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px" />
      </td>
    </tr>
  <tr>
    <td colspan="5" align="center"><b>ADD PHOTOS: *<br>UPLOAD AT LEAST ONE PHOTO</b>&nbsp;&nbsp;&nbsp;&nbsp;<br>
      <input type="hidden" name="MAX_FILE_SIZE" value="3000000" />
...
<input type="hidden" name="MAX_FILE_SIZE" value="3000000" />
<input name="image_file5" type="file" style="color:#333333; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px" /><br>
