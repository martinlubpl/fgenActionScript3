...
<script type="text/javascript" src="themes/default/jscripts/SelectionRect.js"></script>
...
<link href="themes/default/css/crop_tool.css" rel="stylesheet" type="text/css" />
</head>
<body onload="init();">
...
<form onsubmit="return updateSelection();";>
	<div class="toolbar">
		<div class="tools">
			<a href="javascript:saveImage();" onmouseover="switchClass('saveTool','mceButtonOver');" onmouseout="switchClass('saveTool','mceButtonNormal');" onmousedown="switchClass('saveTool','mceButtonNormal');"><img id="saveTool" src="themes/default/images/edit_image/save_tool.gif" border="0" class="mceButtonNormal" alt="Save image" title="Save image" /></a>
			<a href="javascript:revertImage();" onmouseover="switchClass('revertTool','mceButtonOver');" onmouseout="switchClass('revertTool','mceButtonNormal');" onmousedown="switchClass('revertTool','mceButtonNormal');"><img id="revertTool" src="themes/default/images/edit_image/revert_tool.gif" border="0" class="mceButtonNormal" alt="Revert to last saved" title="Revert to last saved" /></a>
			<a href="javascript:toggleSelectionColor();" onmouseover="switchClass('switchSelectionTool','mceButtonOver');" onmouseout="switchClass('switchSelectionTool','mceButtonNormal');" onmousedown="switchClass('switchSelectionTool','mceButtonNormal');"><img id="switchSelectionTool" src="themes/default/images/edit_image/toggle_selection_color.gif" border="0" class="mceButtonNormal" alt="Toggle selection color" title="Toggle selection color" /></a></span>
			<a href="javascript:toggleCropTool();" onmouseover="switchClass('cropTool','mceButtonOver');" onmouseout="switchClass('cropTool','mceButtonNormal');" onmousedown="switchClass('cropTool','mceButtonNormal');"><img id="cropTool" src="themes/default/images/edit_image/crop_tool.gif" border="0" class="mceButtonNormal" alt="Crop image" title="Crop image" /></a>
			<a href="javascript:toggleResizeTool();" onmouseover="switchClass('resizeTool','mceButtonOver');" onmouseout="switchClass('resizeTool','mceButtonNormal');" onmousedown="switchClass('resizeTool','mceButtonNormal');"><img id="resizeTool" src="themes/default/images/edit_image/resize_tool.gif" border="0" class="mceButtonNormal" alt="Resize image" title="Resize image" /></a>
		</div>
		...
		<div id="cropPanel">
			<div class="cropDimentions">
				...
				w: <input type="text" class="inputtext" id="width_field" name="width_field" value="" onchange="updateSelection();" />
				h: <input type="text" class="inputtext" id="height_field" name="height_field" value="" onchange="updateSelection();" />
			</div>
			<div class="confirmAction">
				<a href="javascript:toggleCropTool();" onmouseover="switchClass('cropCancel','mceButtonOver');" onmouseout="switchClass('cropCancel','mceButtonNormal');" onmousedown="switchClass('cropCancel','mceButtonNormal');"><img id="cropCancel" src="themes/default/images/edit_image/cancel.gif" border="0" class="mceButtonNormal" /></a>
				<a href="javascript:cropImage();" onmouseover="switchClass('cropApply','mceButtonOver');" onmouseout="switchClass('cropApply','mceButtonNormal');" onmousedown="switchClass('cropApply','mceButtonNormal');"><img id="cropApply" src="themes/default/images/edit_image/apply.gif" border="0" class="mceButtonNormal" /></a>
			</div>
		</div>

		<div id="resizePanel">
			<div class="cropDimentions">
				w: <input type="text" class="inputtext" id="resize_width_field" name="resize_width_field" value="" onkeyup="updateSelection('width');" onchange="updateSelection('width');" />
				h: <input type="text" class="inputtext" id="resize_height_field" name="resize_height_field" value="" onkeyup="updateSelection('height');" onchange="updateSelection('height');" />
				<input type="checkbox" class="inputcheckbox" id="resize_proportions" name="resize_proportions" checked="checked" /><label>Constrain proportions</label> 
			</div>
			<div class="confirmAction">
				<a href="javascript:toggleResizeTool();" onmouseover="switchClass('resizeCancel','mceButtonOver');" onmouseout="switchClass('resizeCancel','mceButtonNormal');" onmousedown="switchClass('resizeCancel','mceButtonNormal');"><img id="resizeCancel" src="themes/default/images/edit_image/cancel.gif" border="0" class="mceButtonNormal" /></a>
				<a href="javascript:resizeImage();" onmouseover="switchClass('resizeApply','mceButtonOver');" onmouseout="switchClass('resizeApply','mceButtonNormal');" onmousedown="switchClass('resizeApply','mceButtonNormal');"><img id="resizeApply" src="themes/default/images/edit_image/apply.gif" border="0" class="mceButtonNormal" /></a>
			</div>
		</div>
	</div>
