...
function addRow(id, addheight, skip_add) {
	...
	html += '<td><a href="javascript:delRow(\'row_'+ numRows +'\')"><img src="themes/default/images/tool_del.gif" alt="Remove" title="Remove" border="0" /></a></td>';
	...
	<div class="mcHeader mcBorderBottomBlack">
		<div class="mcWrapper">
			<div class="mcHeaderLeft">
				...
				<div class="mcHeaderTitleText">Use the form to upload one or more files.</div>
			</div>
...
<br /><br />
	...
	<div class="mcFooter mcBorderTopBlack">
		<div class="mcBorderTopWhite">
			<div class="mcWrapper">
				<div class="mcFooterLeft"><input type="submit" name="SubmitBtn" value="Upload" class="button" />&nbsp;&nbsp;<input type="button" name="addupload" value="Add Upload" class="button" onclick="addRow('addPosition', true);" /></div>
