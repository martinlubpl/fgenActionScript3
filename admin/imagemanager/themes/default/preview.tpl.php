...
<title>Preview - <?= $this->data['name']; ?> - <?= $this->data['width']; ?>x<?= $this->data['height']; ?> - <?= $this->data['size']; ?></title>
<link href="themes/default/css/preview.css" rel="stylesheet" type="text/css" />
...
<? if ($this->data['previous']['path'] != "") { ?>
	<a href="javascript:previousimage();" alt="Keyboard shortcut: P,LEFTARROW,PAGE UP" title="Keyboard shortcut: P,LEFTARROW,PAGE UP">&lt;&lt;&nbsp;previous</a>
<? } else { ?>
	&lt;&lt;&nbsp;previous
<? } ?>
&nbsp;|&nbsp;
<? if ($this->data['next']['path'] != "") { ?>
<a href="javascript:nextimage();" alt="Keyboard shortcut: SPACE,N,RIGHTARROW,PAGE DOWN" title="Keyboard shortcut: SPACE,N,RIGHTARROW,PAGE DOWN">next&nbsp;&gt;&gt;</a>
<? } else { ?>
	next&nbsp;&gt;&gt;
<? } ?>
</div>
